export default (
	{ LitElement, css, html }, // Pass Lit Element as parameter so as to not repeatedely import when not using a bundler
	availableTargetLangs,
) => customElements.define('ixalang-search', class IxalangSearch extends LitElement {
	#selectedTargetLang = ''
